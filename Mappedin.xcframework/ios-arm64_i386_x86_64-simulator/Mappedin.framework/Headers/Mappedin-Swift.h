...
#ifndef MAPPEDIN_SWIFT_H
#define MAPPEDIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Mappedin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// call <code>setMap(Map)</code> to display the first map.
