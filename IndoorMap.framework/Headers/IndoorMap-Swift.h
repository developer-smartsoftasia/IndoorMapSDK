...
#ifndef INDOORMAP_SWIFT_H
#define INDOORMAP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IndoorMap",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9IndoorMap11AppDelegate")
...
SWIFT_CLASS("_TtC9IndoorMap33SPWChangeFloorPopupViewController")
@interface SPWChangeFloorPopupViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified exploringButton;
...
SWIFT_CLASS("_TtC9IndoorMap32SPWInstructionStepsTableViewCell")
@interface SPWInstructionStepsTableViewCell : UITableViewCell
...
SWIFT_CLASS("_TtC9IndoorMap33SPWInstructionStepsViewController")
@interface SPWInstructionStepsViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified totalDistanceLabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified hideStepsButton;
- (void)viewDidLoad;
- (IBAction)dismisViewController;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
- (IBAction)didTapViewStepsButton;
...
SWIFT_CLASS("_TtC9IndoorMap26SPWNavigationDirectionView")
@interface SPWNavigationDirectionView : UIView
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified centerContainer;
...
SWIFT_CLASS("_TtC9IndoorMap21SPWStoreTableViewCell")
@interface SPWStoreTableViewCell : UITableViewCell
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC9IndoorMap10ShadowView")
