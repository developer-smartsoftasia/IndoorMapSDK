...
install_xcframework "${PODS_ROOT}/MappedIn/Mappedin.xcframework" "Mappedin" "framework" "ios-arm64_i386_x86_64-simulator/Mappedin.framework" "ios-arm64_armv7/Mappedin.framework"
